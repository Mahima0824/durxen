              ...
              <Col lg={6}>
                <div className="p-md-5 p-3">
                  ...
                  <div className="d-flex align-items-center my-4">
                    <div className="border-top border-light border-opacity-25 flex-grow-1"></div>
                  ...
                  <Form onSubmit={handleSubmit} className="mt-4 auth-form">
                    <Form.Group className="mb-4" controlId="formEmail">
                      ...
                      <InputGroup>
                        <InputGroup.Text><i className="ri-mail-fill" /></InputGroup.Text>
                    ...
                    <Form.Group className="mb-4" controlId="formPassword">
                      <div className="d-flex justify-content-between">
                        ...
                        <Link to="/auth/forgot_password" className="text-decoration-underline small text-white text-opacity-75">
                          Forgot Password?
                        </Link>
                      </div>
                      <InputGroup>
                        ...
                        <Form.Control type="password" name="password" placeholder="••••••••" value={formData.password} onChange={handleChange} autoComplete="current-password" required/>
                      </InputGroup>
                    </Form.Group>
                    ...
                    <Button type="submit" variant="primary" size="lg" className="w-100 mb-4">Sign In</Button>

                    <p className="text-center text-white text-opacity-75 mb-0">
